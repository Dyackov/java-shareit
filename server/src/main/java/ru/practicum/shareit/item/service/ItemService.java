...
public interface ItemService {
    ...
    /**
     * Проверяет, имеет ли пользователь, забронировавший вещь, права оставлять комментарий.
     * Если пользователь не бронировал вещь, выбрасывает исключение.
     *
     * @param bookerId Уникальный идентификатор пользователя, бронировавшего вещь
     * @param itemId   Уникальный идентификатор вещи, на которую оставляется комментарий
     * @return Объект модели {@link Booking}, соответствующий найденному бронированию
     */
    Booking checkAuthorAuthorizationForItem(long bookerId, long itemId);
}