...
public class ItemServiceImpl implements ItemService {
    ...
    public ItemDto createItem(long userId, ItemDto itemDto) {
        ...
        if (itemDto.getRequestId() != null) {
            ItemRequest itemRequest = itemRequestServiceImpl.checkItemRequestExist(itemDto.getRequestId());
     ...
     */
    @Override
    public Booking checkAuthorAuthorizationForItem(long bookerId, long itemId) {
        return jpaBookingRepository.checkItemReviewAuthorizationAfterRental(bookerId, itemId, LocalDateTime.now()).orElseThrow(() -> {
